...
public class MediaPlaybackService extends Service {
    ...
    public static final String ACTION_UPDATE = "com.horu.flow.UPDATE";
    public static final String ACTION_PLAY = "com.horu.flow.PLAY";
    public static final String ACTION_PAUSE = "com.horu.flow.PAUSE";
    public static final String ACTION_NEXT = "com.horu.flow.NEXT";
    public static final String ACTION_PREV = "com.horu.flow.PREV";
    public static final String ACTION_STOP = "com.horu.flow.STOP";
    public static final String ACTION_SET_STATE = "com.horu.flow.SET_STATE";
    public static final String ACTION_UPDATE_POSITION = "com.horu.flow.UPDATE_POSITION";

    public static final String BROADCAST_ACTION = "com.horu.flow.MEDIA_ACTION";
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        switch (action) {
            case ACTION_UPDATE:
                ...
                // Build a unique key to avoid reloading same art
            ...
            // From notification buttons — broadcast to JS
            case ACTION_PLAY:
                isPlaying = true;
                updateNotification();
                broadcastAction("play");
            ...
            // From JS plugin — state only, NO broadcast back
            case ACTION_SET_STATE:
                isPlaying = intent.getBooleanExtra("isPlaying", false);
                updateNotification();
                break;

            // Position sync from JS
